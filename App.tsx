...
import { generateIPSString, formatAmount, formatBankAccount } from './utils/ipsGenerator';
import { 
  CreditCard, 
  CheckCircle2, 
  Download, 
...
const App: React.FC = () => {
  ...
  const inputClass = "w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all placeholder-gray-400";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 flex-grow">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm relative group hover:border-blue-200 transition-colors">
                <div className="absolute top-7 right-4 text-gray-300 group-hover:text-blue-400 transition-colors">
                  <User size={18} />
                </div>
            ...
            <div className="space-y-6">
                ...
                <div className="col-span-6">
                  ...
                  <div className="relative">
                    <input 
                      ...
                      onChange={handleInputChange} 
                      className={`${inputClass} text-right pr-8 font-semibold text-blue-900 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none`} 
                      placeholder="0,00" 
                    />
                    <span className="absolute right-3 top-2 text-gray-400 text-sm">RSD</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-400 mt-1">Unesite račun sa ili bez crtica (18 cifara)</p>
              </div>
              ...
              <div className="grid grid-cols-12 gap-3">
                ...
                <div className="col-span-9">
                  <label className={labelClass}>Poziv na broj (odobrenje)</label>
                  <input 
                    name="reference" 
              ...
              <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-100 mt-8">
                 ...
                 <p className="text-yellow-700 text-xs leading-relaxed">
                   Poziv na broj će automatski biti izračunat ako koristite Model 97.
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex justify-between items-center border-b border-blue-500/30 pb-3">
                  <span className="text-blue-200 text-sm">Datum transakcije:</span>
                ...
                <div className="flex justify-between items-center border-b border-blue-500/30 pb-3">
                  ...
                  <span className="font-bold text-xl">{formData.amount ? formatAmount(formData.amount) : '0,00'} <span className="text-sm font-normal text-blue-300">RSD</span></span>
                </div>
                {formData.receiverName && (
                  <div className="flex justify-between items-start border-b border-blue-500/30 pb-3">
                    <span className="text-blue-200 text-sm whitespace-nowrap mr-4">Primalac:</span>
                    <span className="font-medium text-right text-sm truncate">{formData.receiverName}</span>
                  </div>
                )}
              </div>
            </div>
              ...
              <div className="bg-white p-4 rounded-2xl shadow-lg transition-transform hover:scale-105 duration-300">
                {qrString ? (
                  ...
                  <div className="w-[220px] h-[220px] bg-gray-100 rounded-lg flex flex-col items-center justify-center text-gray-400 text-center p-4">
                    ...
                    <span className="text-xs">Unesite račun primaoca i iznos za prikaz koda</span>
                  </div>
                )}
              </div>
              <p className="mt-6 text-sm text-blue-200 flex items-center gap-2">
                <CheckCircle2 size={16} className={qrString ? "text-green-400" : "text-gray-500"} />
                {qrString ? "IPS QR kod je validan" : "Čeka se unos podataka..."}
              </p>
            </div>
